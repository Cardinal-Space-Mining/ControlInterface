...
InfoPlot::InfoPlot(Info rt, Info lt, Info tren, Info hb, Info ha, int buff)
    : right_track(true), left_track(true), trencher(true), hopper_belt(true), hopper_actuator(true), temperature(true), bus_voltage(false), output_perc(false), output_volt(false), output_curr(false), velocity(false), history(buff / 10.0)
{
    right = rt;
    left = lt;
    trench = tren;
